...
<body>
    ...
    <table class="table" style="border: 0p;">
        <tr>
            <td>
                <p>Kontak Pemesan :</p>
                @foreach ($reservasi_wisatum->relationToUser as $user)
            ...
            <td>
                ...
                @foreach ($reservasi_wisatum->relationToRekening as $rekening)
                    ...
                    <p style="font-weight: 0">Total Transfer :
                        Rp.{{ number_format($reservasi_wisatum->total_reservasi) }}</p>
                @endforeach
            </td>
        </tr>
    </table>
