                    ...
                    <div class=" main-card p-3 bg-white rounded-3 mb-2">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-8">
                                ...
                                <p class="paragraph-2">{!! substr(strip_tags($wisata->deskripsi), 0, 250) !!}
                                </p>
                            </div>
                        </div>
                                ...
                                <div class="col-lg-5">
                                    <div class="mb-3">
                                        ...
                                        {{-- <div class="form-check form-check-lg d-flex align-items-end">
                                            <input class="form-check-input" name="roles" type="checkbox" value="DINAS"
                                                id="is-dinas">
                                            <label class="form-check-label text-gray-600" for="is-dinas">
                                                Tidak Bersedia Memberikan Nama
                                            </label>
                                        </div> --}}
                                ...
                                <div class="col-lg-5">
                                    <div class="mb-3">
                                        ...
                                        <input type="date" name="tgl_reservasi" value="{{ old('tgl_reservasi') }}"
                                            ...
                                            id="keberangkatan" min="" max="{{ $wisata->tgl_reservasi_akhir }}">
                                        @error('tgl_reservasi')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
