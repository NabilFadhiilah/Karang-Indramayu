        ...
        <div class="container">
            <div class="row d-flex justify-content-center">
                ...
                <div class="col-lg-3 px-1">
                    ...
                    <a href="Checkout-WIsata.html" class="btn btn-block btn-join-now py-2 col-lg-12 col-12">Reservasi
                        Sekarang</a>
                </div>
            </div>
            <div class="row d-flex justify-content-center">
                ...
                <div class="swiper">
                    <div class="col-lg-10 swiper-wrapper">
                        ...
                        <div class="swiper-slide col-lg-3 bg-white rounded-3 mt-2 mx-1">
                            ...
                            <a href="#" class="btn btn-block btn-wisata-lainnya py-2 col-lg-12 col-12">Lihat
                                Wisata</a>
                        </div>
                        <!--Card Wisata Lainnya-->
                        <div class="swiper-slide col-lg-3 bg-white rounded-3 mt-2 mx-1">
