            ...
            <div class="row" id="nav-tabs" role="tablist">
                ...
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade show active p-1" id="wisata" role="tabpanel"
                        ...
                        <div class="border">
                            @forelse ($pendingWisata as $dataPending)
                                <div class="card row mb-2">
                                    <div class="col-lg-12 py-2 ">
                                        ...
                                        <p class="paragraph-2 mb-1">Batas Pembayaran
                                            {{ $dataPending->tgl_batas_pembayaran }}</p>
                    ...
                    <div class="tab-pane fade p-1" id="paket" role="tabpanel" aria-labelledby="nav-paket-tab">
                        <div class="card row">
                            @forelse ($pendingPaket as $Paket)
                                <div class="col-lg-12 py-2 mb-2">
                                    <div class="d-flex justify-content-between">
                                        @foreach ($Paket->relationToPaket as $detailPaket)
                                            <h4>Pembayaran Paket Wisata {{ $detailPaket->nama_wisata }}</h4>
                                        @endforeach
                                        <h4>ID #{{ $Paket->id }}</h4>
                                    </div>
                                    <p class="paragraph-2 mb-1">Tanggal Reservasi {{ $Paket->tgl_reservasi }}
                                    </p>
                                    <p class="paragraph-2 mb-1">Batas Pembayaran {{ $Paket->tgl_batas_pembayaran }}</p>
                                    <h4 class="mt-2">Bank Tujuan</h4>
                                    @foreach ($Paket->relationToRekening as $rekening)
                                        <div class="d-flex justify-content-between">
                                            <p class="paragraph-2 mb-1">No Rekening Pembayaran</h4>
                                            <p class="paragraph-2 mb-1">{{ $rekening->no_rekening }}</h4>
                                        </div>
