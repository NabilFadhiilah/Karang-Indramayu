...
class ReservasiWisata extends Model
{
    ...
    protected $fillable = [
        'id_user', 'id_wisata', 'id_rekening', 'partisipan_reservasi', 'nama_partisipan', 'tgl_reservasi', 'tgl_pesan_reservasi', 'tgl_batas_pembayaran', 'bukti_reservasi', 'tgl_verifikasi', 'keterangan', 'status_reservasi',  'total_reservasi'
    ];
