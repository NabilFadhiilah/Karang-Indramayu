...
class ReservasiPaketWisata extends Model
{
    ...
    protected $fillable = [
        'id_user', 'id_paket_wisata', 'id_rekening', 'partisipan_reservasi', 'tgl_reservasi', 'tgl_pesan_reservasi', 'tgl_batas_pembayaran', 'bukti_reservasi', 'tgl_verifikasi', 'status_reservasi', 'total_reservasi'
    ];
